...
const LoginPage = () => {
  return ( 
    <div className="flex h-screen w-full overflow-hidden">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center bg-slate-50 dark:bg-slate-950 p-6">
        <div className="w-full max-w-[400px] animate-in fade-in slide-in-from-right duration-700">
           <LoginForm />
        </div>
      </div>
    </div>
